...
//routes
app.use('/', require('./routes/home')); console.log("app.use('/',");//   / 에 도달하면 ./routes/home 개체를 사용하겠다라는 의미 -그런데 실행해보면, 먼저 require를 실행한뒤 app.use 를 실행.
app.use('/users', require('./routes/users')); console.log("app.use('/users'");//   /users 에 도달하면 ./routes/users 개체를 사용하겠다라는 의미
app.use('/posts', require('./routes/posts')); console.log("app.use('/posts'");//   /posts 에 도달하면 ./routes/posts 개체를 사용하겠다라는 의미,
